			...
			<form method="post"
				...
				<fieldset id="field">
					...
					<div>
						...
						<span style="font-size: 25px;">이름 : <input type="text"
							name="name" placeholder="이름을 입력하세요!"></span> <br>
						<br>
						...
						<br> <span style="font-size: 40px;">ID<br> <input
							type="text" name="create_id" placeholder="아이디를 입력하세요!"> <input
							type="button" value="중복확인" onclick="check_id(this.form)">
						</span><br> <span style="font-size: 40px;">PW<br> <input
							type="password" name="create_pw"  style="width: 200px;" placeholder="비밀번호를 입력하세요!"></span><br>
						<span style="font-size: 40px;">Confirm PW<br> <input
							type="password" name="create_cpw" style="width: 200px;" placeholder="비밀번호를 다시한번 입력하세요!"></span><br>
						<br> <br> <input type="button" style="text-align: center; width:200px; height: 60px; font-size: 25px;" value="CreateAccount"
