...
<div id="monitor">
		...
		<div id="page">
			...
			<div id="left_contain">
				<ul>
					<li>단어명: <input type="text" name="word_name" placeholder="단어명을 입력하세요."> </li>
					<p>단어뜻</p>
					<li> <textarea rows="8" cols="50" placeholder="단어뜻을 입력하세요."></textarea> </li>
				</ul>
			</div>
			...
			<div id="foot_contain">
				<ul>
					<li> 예제 : <input type="text" name="word_ex" placeholder="예제를 입력하세요." style="width:400px;"> </li>
					<li> 예제 : <input type="text" name="word_ex" placeholder="예제를 입력하세요." style="width:400px;"> </li>
				</ul>
			</div>
			<div>
