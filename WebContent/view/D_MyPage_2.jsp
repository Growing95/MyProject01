		...
		<div id="content">
			...
			<div id="user_img">
				<form>
					...
					<div class="user_info">
						<p>기존비밀번호</p>
						<input type="password" name="password" placeholder="기존비밀번호입력">
						<p>새비밀번호</p>
						<input type="password" name="password" placeholder="기존비밀번호입력">
						<p>새비밀번호 확인</p>
						<input type="password" name="password" placeholder="기존비밀번호입력"><br>
						<br>
						<br> <input
							style="width: 150px; height: 80px; font-size: 15px;"
							type="button" value="비밀번호 변경하기">
					</div>
				</form>
			</div>
		</div>
