		...
		<div>
			<form method="post"
				...
				<fieldset id="field">
					...
					<br> <span style="font-size: 40px;">이름<br>
					<input type="text" name="create_id" placeholder="이름을 입력하세요!">
						...
						<hr>
						<br>
						<a href="D_find_pw.jsp" style="color:black; font-size: 25px;">비밀번호를 찾으시나요?</a>
						<br>
						<br>
						<br>
						<div id="go_login">
